...
import { PHONE_COUNTRIES, PHONE_COUNTRY_IDS, validatePhone, type PhoneCountry } from './validator.js';
...
export { validatePhone, generatePhone, PHONE_COUNTRY_IDS, type PhoneCountry };