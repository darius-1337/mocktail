...
export const date: Kind = {
    id: 'date',
    label: 'Calendar Date',
    description: 'ISO 8601 calendar date (YYYY-MM-DD). Higher bands favour month boundaries, 29 February in leap years, and dates that break systems: the Unix epoch, the 2038 signed 32-bit limit, and year 9999.',
    params: [
        {
      name: 'from',
